...
if __name__ == '__main__':
  ...
  for sequence in test_sequences:
    ...
    #seq_scan_names = sorted(seq_scan_names)
    #seq_scan_names = [item for index, item in enumerate(seq_scan_names) if (index) % skip_frames == 0]
  ...
  for sequence in test_sequences:
    ...
    #seq_label_names = sorted(seq_label_names)
    #seq_label_names = [item for index, item in enumerate(seq_label_names) if (index) % skip_frames == 0]
