  ...
  def __init__(self, ARCH, nclasses, path=None, path_append="", strict=False):
    ...
    if path is not None:
      ...
      try:
        ...
        print("Successfully loaded model backbone weights: ", path + "/backbone" + path_append)
      ...
      try:
        ...
        print("Successfully loaded model decoder weights: ", path + "/segmentation_decoder" + path_append,)
      except Exception as e:
      ...
      try:
        ...
        print("Successfully loaded model head weights: ", path + "/segmentation_head" + path_append)
      except Exception as e:
